                    ...
                    const mp::VMSpecs& specs)
{
    json = {{"num_cores", specs.num_cores},
            ...
            {"mounts", boost::json::value_from(specs.mounts, map_as_array{"target_path"})},
                           ...
                           const boost::json::value& json)
{
    ...
    if (!mpu::valid_mac_address(mac_addr))
    ...
    return {value_to<int>(json.at("num_cores")),
            ...
            value_to<mounts_t>(json.at("mounts"), map_as_array{"target_path"}),
            value_to<bool>(json.at("deleted")),
