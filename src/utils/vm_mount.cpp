                    ...
                    const mp::VMMount& mount)
{
    json = {{"source_path", mount.source_path},
            {"gid_mappings", boost::json::value_from(mount.gid_mappings, id_mapping_type::gid)},
            {"uid_mappings", boost::json::value_from(mount.uid_mappings, id_mapping_type::uid)},
                           ...
                           const boost::json::value& json)
{
    return {value_to<std::string>(json.at("source_path")),
            value_to<id_mappings>(json.at("gid_mappings"), id_mapping_type::gid),
            value_to<id_mappings>(json.at("uid_mappings"), id_mapping_type::uid),
