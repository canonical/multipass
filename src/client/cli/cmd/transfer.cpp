...
multipass::ParseCode cmd::Transfer::parse_sources(multipass::ArgParser *parser, bool allow_templates)
{
...
multipass::ParseCode cmd::Transfer::parse_destination(multipass::ArgParser *parser, bool allow_templates)
{
