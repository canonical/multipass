...
std::string generate_instance_details(const mp::InfoReply reply)
{
    ...
    fmt::format_to(
        ...
        "Name,State,Zone,Ipv4,Ipv6,Release,Image hash,Image release,Load,Disk usage,Disk total,Memory usage,Memory "
...
std::string generate_instances_list(const mp::InstancesList& instance_list)
{
    ...
    fmt::format_to(std::back_inserter(buf), "Name,State,IPv4,IPv6,Release,AllIPv4,Zone\n");
