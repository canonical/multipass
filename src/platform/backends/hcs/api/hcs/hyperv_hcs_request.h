...
#include <hcs/api/hcs/hyperv_hcs_modify_memory_settings.h>
#include <hcs/api/hcs/hyperv_hcs_network_adapter.h>
#include <hcs/api/hcs/hyperv_hcs_request_type.h>
#include <hcs/api/hcs/hyperv_hcs_resource_path.h>
