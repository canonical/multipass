...
#include <hcs/api/hcn/hyperv_hcn_ipam.h>
#include <hcs/api/hcn/hyperv_hcn_network_flags.h>
#include <hcs/api/hcn/hyperv_hcn_network_policy.h>
#include <hcs/api/hcn/hyperv_hcn_network_type.h>
