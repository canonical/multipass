...
{
    return {QString::fromStdString(value_to<std::string>(json.at(::json_tag_name))),
            QString::fromStdString(value_to<std::string>(json.at(::json_html_url))),
            QString::fromStdString(mp::lookup_or<std::string>(json, ::json_title, "")),
            QString::fromStdString(mp::lookup_or<std::string>(json, ::json_description, ""))};
}
