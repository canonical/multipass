...
function(prepare_windows_version_resource OUTPUT_VAR TARGET_BASENAME FILE_DESCRIPTION INTERNAL_NAME ORIGINAL_FILENAME)
  ...
  if(NOT MULTIPASS_VERSION_MAJOR MATCHES "^[0-9]+$" OR
    NOT MULTIPASS_VERSION_MINOR MATCHES "^[0-9]+$" OR
    NOT MULTIPASS_VERSION_PATCH MATCHES "^[0-9]+$")
      message(FATAL_ERROR "Invalid version components; expected numeric MULTIPASS_VERSION_MAJOR/MINOR/PATCH
        but got '${MULTIPASS_VERSION_MAJOR}.${MULTIPASS_VERSION_MINOR}.${MULTIPASS_VERSION_PATCH}'")
  endif()
