...
Multipass is tested with **Qt 6.9.2**. Newer patch versions along the 6.9 track (e.g. 6.9.8) should be fine. Newer minor versions may work, but they may cause compatibility issues.
