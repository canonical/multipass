...
Install the latest stable version of Qt6 LTS (6.9.2 at the moment): <http://www.qt.io/download-open-source/>.
...
Add Qt6 to your PATH environment variable, adding to your `.bash_profile` file the following line:
    ...
    export PATH=$PATH:~/Qt/6.9.2/clang_64/bin
...
To build with official Qt sources do:
    ...
    cmake -Bbuild -H. -GNinja -DCMAKE_PREFIX_PATH=~/Qt/6.9.2/clang_64
