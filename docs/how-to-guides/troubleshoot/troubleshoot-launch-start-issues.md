...
- **Run [`fsck`](https://manpages.ubuntu.com/manpages/stonking/en/man8/fsck.8.html) in the Serial Console:**
...
One example is [`qemu-nbd`](https://manpages.ubuntu.com/manpages/stonking/en/man8/qemu-nbd.8.html), which allows mounting the image. This tool is not shipped with Multipass, so you would need to install it manually.
