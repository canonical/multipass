# Service
> See also: [Command-line interface](/reference/command-line-interface/command-line-interface), [GUI client](/reference/gui-client), [Instance](/explanation/instance), [Use Multipass remotely](/)
