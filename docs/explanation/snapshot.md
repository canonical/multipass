...
You can view a list of the available snapshots with `multipass snapshots` and the details of a particular snapshot with `multipass info <instance>.<snapshot>`. To delete a snapshot, use the [`delete`](/reference/command-line-interface/delete) command.

> See also: [`snapshots`](/reference/command-line-interface/snapshots), [`info`](/reference/command-line-interface/info), [`delete`](/reference/command-line-interface/delete)
