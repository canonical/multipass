...
- [Visual Studio Code](#visual-studio-code)
    ...
    - [Debugging](#debugging-1)
        - [Locally](#locally)
        - [Using development containers](#using-development-containers)
...
A [launch.json](./.vscode/launch.json) file providing several configurations is available.
...
- On Windows, the `Debug daemon` configuration will not work in an IDE run without elevated privileges. We recommend developing from an isolated environment, such as a VM or a container (see below), if you want to run Visual Studio Code as administrator.
...
Once inside the container, you can use Visual Studio Code as if it were running on your local system.
