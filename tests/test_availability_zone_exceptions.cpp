...
TEST(TestAvailabilityZoneExceptions, formats_availability_zone_deserialization_error)
{
...
TEST(TestAvailabilityZoneExceptions, formats_availability_zone_manager_deserialization_error)
{
...
TEST(TestAvailabilityZoneExceptions, formats_availability_zone_not_found_error)
{
...
TEST(TestAvailabilityZoneExceptions, formats_no_availability_zone_available_error)
{
