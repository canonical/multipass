...
auto construct_find_one_blueprint_reply()
{
    ...
    blueprint_entry->add_aliases("anbox-cloud-appliance");
...
const std::vector<FormatterParamType> find_formatter_outputs{
    ...
    {&table_formatter,
     ...
     mpt::load_test_file("formatters/table/empty_find_reply_only_images.txt").toStdString(),
     "table_find_empty_only_images"},
    {&table_formatter,
     &empty_find_reply_only_blueprints,
     mpt::load_test_file("formatters/table/empty_find_reply_only_blueprints.txt").toStdString(),
    ...
    {&table_formatter,
     ...
     mpt::load_test_file("formatters/table/find_one_blueprint_reply.txt").toStdString(),
    ...
    {&json_formatter,
     &empty_find_reply,
     mpt::load_test_file("formatters/json/json_empty_find_reply.json").toStdString(),
     "json_find_empty"},
    {&json_formatter,
     &empty_find_reply_only_images,
     mpt::load_test_file("formatters/json/json_empty_find_reply.json").toStdString(),
    ...
    {&json_formatter,
     &find_one_blueprint_reply,
     mpt::load_test_file("formatters/json/find_one_blueprint_reply.json").toStdString(),
    ...
    {&csv_formatter,
     &empty_find_reply,
     mpt::load_test_file("formatters/csv/csv_empty_find_reply.csv").toStdString(),
     "csv_find_empty"},
    {&csv_formatter,
     &empty_find_reply_only_images,
     mpt::load_test_file("formatters/csv/csv_empty_find_reply.csv").toStdString(),
    ...
    {&csv_formatter,
     &find_one_blueprint_reply,
     mpt::load_test_file("formatters/csv/find_one_blueprint_reply.csv").toStdString(),
    ...
    {&yaml_formatter,
     &empty_find_reply,
     mpt::load_test_file("formatters/yaml/yaml_empty_find_reply.yaml").toStdString(),
     "yaml_find_empty"},
    {&yaml_formatter,
     &empty_find_reply_only_images,
     mpt::load_test_file("formatters/yaml/yaml_empty_find_reply.yaml").toStdString(),
    ...
    {&yaml_formatter,
     &find_one_blueprint_reply,
     mpt::load_test_file("formatters/yaml/find_one_blueprint_reply.yaml").toStdString(),
