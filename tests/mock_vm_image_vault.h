...
public:
    MockVMImageVault()
    {
        ON_CALL(*this, fetch_image(_, _, _, _, _))
            .WillByDefault([this](auto, auto, const PrepareAction& prepare, auto, auto) {
    ...
    MOCK_METHOD5(fetch_image, VMImage(const FetchType&, const Query&, const PrepareAction&, const ProgressMonitor&,
