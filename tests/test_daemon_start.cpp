...
//     EXPECT_CALL(server, Write(Property(&mp::StartReply::log_line, HasSubstr("Cannot create a SSH shell")),
//     _)).Times(1);
...
//     {
//         EXPECT_CALL(server,
//                     Write(Property(&mp::StartReply::log_line, HasSubstr("Failure configuring network interfaces")),
//                     _))
//             .Times(1);
//     }
//     else
