...
namespace test
{
const QByteArray not_found_data{
...
const QByteArray vm_info_data_with_image_release{
    ...
    "    \"image.os\": \"ubuntu\","
    "    \"image.release\": \"bionic\","
    "    \"image.release_title\": \"Fake Title\"," // This is to ensure this is what is used in the
                                                   // test
    "    \"image.serial\": \"20200506\","
    "    \"image.type\": \"disk1.img\","
    "    \"image.version\": \"18.04\","
    ...
    "      \"image.os\": \"ubuntu\","
    "      \"image.release\": \"bionic\","
    "      \"image.release_title\": \"Fake Title\"," // This is to ensure this is what is used in
                                                     // the test
    "      \"image.serial\": \"20200506\","
    "      \"image.type\": \"disk1.img\","
    "      \"image.version\": \"18.04\","
...
const QByteArray vm_custom_info_data{
    ...
    "    \"image.original_hash\": "
    "\"6937ddd3f4c3329182855843571fc91ae4fee24e8e0eb0f7cdcf2c22feed4dab\","
    "    \"image.os\": \"\","
