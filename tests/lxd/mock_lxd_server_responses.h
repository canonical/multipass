...
const QByteArray post_no_error_response{"HTTP/1.1 200 OK\r\n"
                                        "Content-Type: application/json\r\n\r\n"
                                        "{"
                                        "\"error\": \"\","
                                        "\"error_code\": 0,"
...
const QByteArray project_info_response{"HTTP/1.1 200 OK\r\n"
                                       "Content-Type: application/json\r\n\r\n"
                                       "{"
                                       "\"error\": \"\","
                                       "\"error_code\": 0,"
...
const QByteArray network_info_response{"HTTP/1.1 200 OK\r\n"
                                       "Content-Type: application/json\r\n\r\n"
                                       "{"
                                       "\"error\": \"\","
                                       "\"error_code\": 0,"
