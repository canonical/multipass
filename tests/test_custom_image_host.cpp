...
TEST_F(CustomImageHost, all_images_for_snapcraft_returns_four_matches)
{
    mp::CustomVMImageHost host{"x86_64", &mock_url_downloader, default_ttl};
...
TEST_F(CustomImageHost, all_images_for_snapcraft_unsupported_alias_returns_three_matches)
{
    mp::CustomVMImageHost host{"x86_64", &mock_url_downloader, default_ttl};
