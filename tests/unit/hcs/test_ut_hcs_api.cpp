...
#include "hcs/api/hcs/hcs_create_compute_system_params.h"
#include "hcs/api/hcs/hcs_wrapper.h"
#include "hyperv_test_utils.h"
#include "mock_hcs_api.h"
...
struct HyperVHCSAPI_UnitTests : public ::testing::Test
{
    ...
    void verify_create_compute_system_failure(const CreateComputeSystemParameters& params)
    {
