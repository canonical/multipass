...
TEST_F(PlatformLinux, create_alias_script_works_unconfined)
{
    ...
    EXPECT_NO_THROW(MP_PLATFORM.create_alias_script("alias_name", mp::AliasDefinition{"instance", "command", true}));
...
TEST_F(PlatformLinux, create_alias_script_overwrites)
{
    ...
    EXPECT_NO_THROW(
        MP_PLATFORM.create_alias_script("alias_name", mp::AliasDefinition{"instance", "other_command", true}));
}
...
TEST_F(PlatformLinux, create_alias_script_throws_if_cannot_create_path)
{
    ...
    MP_EXPECT_THROW_THAT(
        MP_PLATFORM.create_alias_script("alias_name", mp::AliasDefinition{"instance", "command", true}),
